...
@{
    ...
    'Set-nbVlanGroup', 'Set-nbVMInterface', 'Set-nbVrf', 'Remove-nbAggregate',
    'Remove-nbCircuit', 'Remove-nbCircuitTermination', 'Remove-nbCircuitType',
    ...
    'Remove-nbDeviceRole', 'Remove-nbDeviceType', 'Remove-nbExportTemplate',
    'Remove-nbGraph', 'Remove-nbImageAttachment', 'Remove-nbInterface',
    'Remove-nbInterfaceConnection', 'Remove-nbInterfaceTemplate', 'Remove-nbInventoryItem',
    'Remove-nbIpAddress', 'Remove-nbManufacturer', 'Remove-nbObject', 'Remove-nbPlatform',
    'Remove-nbPowerConnection', 'Remove-nbPowerOutlet', 'Remove-nbPowerOutletTemplate',
    'Remove-nbPowerPort', 'Remove-nbPowerPortTemplate', 'Remove-nbPrefix', 'Remove-nbProvider',
    'Remove-nbRack', 'Remove-nbRackGroup', 'Remove-nbRackReservation', 'Remove-nbRackRole',
    'Remove-nbRecentActivity', 'Remove-nbRegion', 'Remove-nbReport', 'Remove-nbRir',
    'Remove-nbRole', 'Remove-nbService', 'Remove-nbSite', 'Remove-nbTenant',
    'Remove-nbTenantGroup', 'Remove-nbTopologyMap', 'Remove-nbVirtualChassis',
    'Remove-nbVirtualMachine', 'Remove-nbVlan', 'Remove-nbVlanGroup',
    'Remove-nbVMInterface', 'Remove-nbVrf', 'Remove-nbObject'
